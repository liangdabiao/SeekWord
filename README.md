...
| **DeepSeek** | OpenAI Compatible | [platform.deepseek.com](https://platform.deepseek.com/) | `https://api.deepseek.com/chat/completions` | `deepseek-v4-flash`（快省）/ `deepseek-v4-pro`（强）/ `deepseek-v4-flash-vision-exp` |
